...
public class App 
{
    ...
    public static void initMonkeyIsland() {
        ...
        Release voMsdos1_1 = new Release("Veršffentlichung 1-1 (PC, 5,25, DV, 256 Farben)", DistributionKey.RegularBox);
        voMsdos1_1.addCountryRelease(new CountryRelease(CountryKey.Deutschland, 1990));
        vogDos.addRelease(voMsdos1_1);
        
        Release voMsdos1_11 = new Release("Veršffentlichung 1-11 (PC, CD, EU, 256 Farben)", DistributionKey.RegularBox);
        ...
        Release voAmiga4_1 = new Release("Veršffentlichung 4-1 (Amiga, 3,5, DV)", DistributionKey.RegularBox);
        voAmiga4_1.addCountryRelease(new CountryRelease(CountryKey.Deutschland, 1991));
        Release voAmiga4_2 = new Release("Veršffentlichung 4-2 (Amiga, 3,5, UK)", DistributionKey.RegularBox);
        voAmiga4_2.addCountryRelease(new CountryRelease(CountryKey.UK, 1991));
        Release voAmiga4_3 = new Release("Veršffentlichung 4-3 (Amiga, 3,5, UK Kixx)", DistributionKey.RegularBox);
        ...
        Release voSt6_1 = new Release("Veršffentlichung 6-1 (Atari ST, 3,5, DV)", DistributionKey.RegularBox);
        voSt6_1.addCountryRelease(new CountryRelease(CountryKey.Deutschland, 1991));
        Release voSt6_2 = new Release("Veršffentlichung 6-2 (Atari ST, 3,5, US)", DistributionKey.RegularBox);
        voSt6_2.addCountryRelease(new CountryRelease(CountryKey.USA, 1991));
        Release voSt6_3 = new Release("Veršffentlichung 6-3 (Atari ST, 3,5, UK)", DistributionKey.RegularBox);
        ...
        Release voApple7_1 = new Release("Veršffentlichung 7-1 (Apple Macintosh, 3,5, US)", DistributionKey.RegularBox);
...
//        System.out.println(xml);
    ...
    public static void initResidentEvil() {
        ...
        Release voPs1_1 = new Release("Veršffentlichung 1-1 (PSX, CD, DV)", DistributionKey.RegularBox);
        ...
        Release voPs1_2 = new Release("Veršffentlichung 1-2 (PSX, CD, DV, White Label)", DistributionKey.RegularBox);
        voPs1_2.addCountryRelease(new CountryRelease(CountryKey.Deutschland, 9999));
        vogPlaystation.addRelease(voPs1_2);
        
        Release voPs1_3 = new Release("Veršffentlichung 1-3 (PSX, CD, DV, Platinum Edition)", DistributionKey.RegularBox);
