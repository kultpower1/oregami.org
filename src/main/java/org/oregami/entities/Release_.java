...
@Generated(value="Dali", date="2011-11-29T20:41:51.558+0100")
@StaticMetamodel(Release.class)
public class Release_ extends BaseEntity_ {
	public static volatile SingularAttribute<Release, DistributionKey> distributionKey;
	...
	public static volatile SetAttribute<Release, CountryRelease> countryRelease;
}
